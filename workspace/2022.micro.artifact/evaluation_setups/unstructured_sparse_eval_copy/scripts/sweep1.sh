...
# Sweep script for UNSTRUCTURED sparsity
...
echo "============================================================="
echo "All UNSTRUCTURED workloads processed."
echo "=============================================================" 